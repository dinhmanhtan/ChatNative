...
const CallScreen = props => {
  ...
  const {isIncomingCall, isVideoCall, callee, chatroomID} = props.route.params;
  const [callState, setCallState] = useState('Connecting');
  const callId = useRef(props.route.params.callId);
  ...
  useEffect(() => {
    ...
    function subscribeToCallEvents() {
      ...
      call.on(Voximplant.CallEvents.Disconnected, callEvent => {
        ...
        //if (chatroomID) navigation.navigate('ChatRoom', {id: chatroomID});
